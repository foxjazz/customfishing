...
export class SpcontainerComponent implements OnInit {
  ...
  populateData() {
    // let a =
      ...
      let a: spdata = {title: "Suburu", child: null, level: 1, content: "mycontent", id: 1, selectCss: "normal"};
      spl.list.push(a);
      a = ({title: "BMW", child: null, level: 1, content: "mycontent", id: 2, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Toyota", child: null, level: 1, content: "mycontent", id: 3, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Mazda", child: null, level: 1, content: "mycontent", id: 4, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Infinity", child: null, level: 1, content: "mycontent", id: 5, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Porshe", child: null, level: 1, content: "mycontent", id: 6, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Dodge", child: null, level: 1, content: "mycontent", id: 7, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Ford", child: null, level: 1, content: "mycontent", id: 8, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Tesla", child: null, level: 1, content: "mycontent", id: 9, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Kia", child: null, level: 1, content: "mycontent", id: 10, selectCss: "normal"});
      spl.list.push(a);
      a = ({title: "Chevy", child: null, level: 1, content: "mycontent", id: 11, selectCss: "normal"});
      spl.list.push(a);
